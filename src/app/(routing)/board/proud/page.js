...
import FreeBoardDesktop from "@/app/components/Board/Free/Templates/Board/DesktopFreeBoard.js";
import FreeBoardMobile from "@/app/components/Board/Free/Templates/Board/MobileFreeBoard.js";
...
export default function FreeBoardPage() {
  ...
  return (
    <>
      {isMobile ? (
        <FreeBoardMobile posts={dummyPosts} />
      ) : (
        <FreeBoardDesktop posts={dummyPosts} />
      )}
    </>
  );
}